...
const HelpDialog = (props: any) => {
  ...
  return (
    <Dialog
      ...
      open={open}
    >
      <DialogTitle id="simple-dialog-title">Help: Processing Rules</DialogTitle>
      <DialogContent dividers={scroll === "paper"}>
        <DialogContentText>
          ...
          <p>
            ...
            manual work when uploading documents by automatically detecting
            document and modifying its contents. The idea is to configure a set
            of conditions that must match, and running a set of actions for
            documents that match the conditions.
          </p>
          <p>
            Processing rules can try to detect document content, name,
            description or metadata and modify the same fields.
          </p>
          <p>
            If e.g. Google regularly sends invoices, it might make sense to try
            to detect documents where:
            <ol>
          ...
          <p>
            ...
            <ul>
              <li>
                Enabled: user can toggle each condition on and off without
                deleting it
              </li>
              <li>
                Case insensitive: whether to match text in case insensitive.
                Only applies to name, description or content filters
              </li>
              <li>
          ...
          <p>
            ...
            <ul>
              <li>
                Enabled: user can toggle each action on and off without deleting
                it.
              </li>
              <li>
                On condition: if true, action is only executed when conditions
                are met. If false, action is executed if conditions are not met
              </li>
            </ul>
          </p>
          ...
          <ul>
            <li>
              Try to create filters that are as strict as possible. E.g.
              matching content with 'Google' probably matches many more
